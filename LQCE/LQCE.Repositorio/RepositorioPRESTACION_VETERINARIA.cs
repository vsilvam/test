...
namespace LQCE.Repositorio
{
	public partial class RepositorioPRESTACION_VETERINARIA
	{
        ...
        public PRESTACION_VETERINARIA GetById(int id)
        {
            ...
            try
            {
                return _contextBd.PRESTACION_VETERINARIA
					.Include("ESPECIE")				
					.Include("RAZA")				
        ...
        public IQueryable<PRESTACION_VETERINARIA> GetAll()
        {
            ...
            try
            {
                return from i in _contextBd.PRESTACION_VETERINARIA select i;
            }
            catch (Exception ex)
            {
                ISException.RegisterExcepcion(ex);
        ...
        /// <returns></returns>
        public int Insert(PRESTACION_VETERINARIA entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.AddToPRESTACION_VETERINARIA(entity);
        ...
        /// <returns></returns>
        public bool Update(PRESTACION_VETERINARIA entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.ApplyPropertyChanges("PRESTACION_VETERINARIA", entity);
