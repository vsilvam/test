	...
	public partial class RepositorioCARGA_PRESTACIONES_VETERINARIAS_EXAMEN
	{
		...
		public CARGA_PRESTACIONES_VETERINARIAS_EXAMEN GetByIdWithReferences(int id)
		{
			...
			try
			{
							...
							return _context.CARGA_PRESTACIONES_VETERINARIAS_EXAMEN.Include("CARGA_PRESTACIONES_VETERINARIAS_DETALLE").Include("EXAMEN").FirstOrDefault(i => i.ID == id);
		...
		public IQueryable<CARGA_PRESTACIONES_VETERINARIAS_EXAMEN> GetAllWithReferences()
		{
			...
			try
			{
								...
								var q = from i in _context.CARGA_PRESTACIONES_VETERINARIAS_EXAMEN.Include("CARGA_PRESTACIONES_VETERINARIAS_DETALLE").Include("EXAMEN") select i;
							return q;
			}
			catch (Exception ex)
            {
