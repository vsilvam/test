...
namespace LQCE.Transaccion
{
	public partial class TrxCLIENTE_SINONIMO
	{
		...
		public CLIENTE_SINONIMO GetById(int id)
		{
			...
			{
				var dato = new RepositorioCLIENTE_SINONIMO(context);
      ...
      /// </summary>
      /// <returns></returns>
      public IList<CLIENTE_SINONIMO> GetAll()
      {
          Init();
      ...
      /// <returns></returns>
      public IList<CLIENTE_SINONIMO> Find(DTO_CLIENTE_SINONIMO dto)
      {
          Init();
      ...
      /// <returns></returns>
      public int Save(CLIENTE_SINONIMO entity)
      {
          Init();

          if (entity == null)
          {
              Error = "ArgumentNullException. La entidad a persistir 'CLIENTE_SINONIMO' no puede ser nula.";
      ...
      public bool Delete(int id)
      {
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (entity == null)
              {
                  Error = String.Format("Registro '{0}' en 'CLIENTE_SINONIMO' no encontrado. {1}", id, dato.Error);
                  ISException.RegisterExcepcion(Error);
                  return false;
              }
