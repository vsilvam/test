...
namespace LQCE.Transaccion
{
	public partial class TrxNOTA_COBRO_DETALLE
	{
		...
		public NOTA_COBRO_DETALLE GetById(int id)
		{
			...
			{
				var dato = new RepositorioNOTA_COBRO_DETALLE(context);
      ...
      /// </summary>
      /// <returns></returns>
      public IList<NOTA_COBRO_DETALLE> GetAll()
      {
          Init();
      ...
      /// <returns></returns>
      public IList<NOTA_COBRO_DETALLE> Find(DTO_NOTA_COBRO_DETALLE dto)
      {
          Init();
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (dto != null)
              {
					...
					if (dto.MONTO_PENDIENTE != null)
						q = q.Where(i => i.MONTO_PENDIENTE  == dto.MONTO_PENDIENTE);		
					if (dto.ACTIVO != null)
						q = q.Where(i => i.ACTIVO  == dto.ACTIVO);		
					if (dto.ID_FACTURA != null)
						q = q.Where(i => i.FACTURA.ID == dto.ID_FACTURA);				
					if (dto.ID_NOTA_COBRO != null)
						q = q.Where(i => i.NOTA_COBRO.ID == dto.ID_NOTA_COBRO);				
              }
      ...
      /// <returns></returns>
      public int Save(NOTA_COBRO_DETALLE entity)
      {
          Init();

          if (entity == null)
          {
              Error = "ArgumentNullException. La entidad a persistir 'NOTA_COBRO_DETALLE' no puede ser nula.";
          ...
          using (var context = new LQCEEntities())
          {
              ...
              oldEntity.MONTO_PENDIENTE = entity.MONTO_PENDIENTE;				
      ...
      public bool Delete(int id)
      {
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (entity == null)
              {
                  Error = String.Format("Registro '{0}' en 'NOTA_COBRO_DETALLE' no encontrado. {1}", id, dato.Error);
                  ISException.RegisterExcepcion(Error);
                  return false;
              }
