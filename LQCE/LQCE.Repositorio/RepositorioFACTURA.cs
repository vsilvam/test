...
namespace LQCE.Repositorio
{
	public partial class RepositorioFACTURA
	{
        ...
        public IQueryable<FACTURA> GetAll()
        {
            ...
            try
            {
                return from i in _contextBd.FACTURA select i;
            }
            catch (Exception ex)
            {
                ISException.RegisterExcepcion(ex);
        ...
        /// <returns></returns>
        public int Insert(FACTURA entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.AddToFACTURA(entity);
        ...
        public bool Update(FACTURA entity)
        {
            ...
            try
            {
                _contextBd.ApplyPropertyChanges("FACTURA", entity);
