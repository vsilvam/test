	...
	public partial class RepositorioCLIENTE
	{
		...
		public CLIENTE GetByIdWithReferences(int id)
		{
			...
			try
			{
							...
							return _context.CLIENTE.Include("COMUNA").Include("CONVENIO").Include("CLIENTE_SINONIMO").Include("TIPO_PRESTACION").Include("FACTURA").Include("PAGO").Include("PRESTACION").Include("CARGA_PRESTACIONES_HUMANAS_DETALLE").Include("CARGA_PRESTACIONES_VETERINARIAS_DETALLE").Include("TIPO_FACTURA").Include("NOTA_COBRO").FirstOrDefault(i => i.ID == id && i.ACTIVO );
		...
		public IQueryable<CLIENTE> GetAllWithReferences()
		{
			...
			try
			{
								...
								var q = from i in _context.CLIENTE.Include("COMUNA").Include("CONVENIO").Include("CLIENTE_SINONIMO").Include("TIPO_PRESTACION").Include("FACTURA").Include("PAGO").Include("PRESTACION").Include("CARGA_PRESTACIONES_HUMANAS_DETALLE").Include("CARGA_PRESTACIONES_VETERINARIAS_DETALLE").Include("TIPO_FACTURA").Include("NOTA_COBRO") where i.ACTIVO  select i;
							return q;
			}
			catch (Exception ex)
            {
