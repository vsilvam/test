...
namespace LQCE.Repositorio
{
	public partial class RepositorioCOMUNA
	{
        ...
        public IQueryable<COMUNA> GetAll()
        {
            ...
            try
            {
                return from i in _contextBd.COMUNA select i;
            }
            catch (Exception ex)
            {
                ISException.RegisterExcepcion(ex);
        ...
        /// <returns></returns>
        public int Insert(COMUNA entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.AddToCOMUNA(entity);
        ...
        /// <returns></returns>
        public bool Update(COMUNA entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.ApplyPropertyChanges("COMUNA", entity);
