...
namespace LQCE.Transaccion
{
	public partial class TrxEXAMEN_SINONIMO
	{
		...
		public EXAMEN_SINONIMO GetById(int id)
		{
			...
			{
				var dato = new RepositorioEXAMEN_SINONIMO(context);
      ...
      /// </summary>
      /// <returns></returns>
      public IList<EXAMEN_SINONIMO> GetAll()
      {
          Init();
      ...
      /// <returns></returns>
      public IList<EXAMEN_SINONIMO> Find(DTO_EXAMEN_SINONIMO dto)
      {
          Init();
      ...
      /// <returns></returns>
      public int Save(EXAMEN_SINONIMO entity)
      {
          Init();

          if (entity == null)
          {
              Error = "ArgumentNullException. La entidad a persistir 'EXAMEN_SINONIMO' no puede ser nula.";
      ...
      public bool Delete(int id)
      {
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (entity == null)
              {
                  Error = String.Format("Registro '{0}' en 'EXAMEN_SINONIMO' no encontrado. {1}", id, dato.Error);
                  ISException.RegisterExcepcion(Error);
                  return false;
              }
