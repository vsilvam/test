...
namespace LQCE.Repositorio
{
	public partial class RepositorioESPECIE
	{
        ...
        public IQueryable<ESPECIE> GetAll()
        {
            ...
            try
            {
                return from i in _contextBd.ESPECIE select i;
            }
            catch (Exception ex)
            {
                ISException.RegisterExcepcion(ex);
        ...
        /// <returns></returns>
        public int Insert(ESPECIE entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.AddToESPECIE(entity);
        ...
        public bool Update(ESPECIE entity)
        {
            ...
            try
            {
                _contextBd.ApplyPropertyChanges("ESPECIE", entity);
