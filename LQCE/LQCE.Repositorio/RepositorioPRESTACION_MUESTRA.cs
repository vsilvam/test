...
namespace LQCE.Repositorio
{
	public partial class RepositorioPRESTACION_MUESTRA
	{
        ...
        public PRESTACION_MUESTRA GetById(int id)
        {
            ...
            try
            {
                return _contextBd.PRESTACION_MUESTRA
					.Include("PRESTACION")				
        ...
        public IQueryable<PRESTACION_MUESTRA> GetAll()
        {
            ...
            try
            {
                return from i in _contextBd.PRESTACION_MUESTRA select i;
            }
            catch (Exception ex)
            {
                ISException.RegisterExcepcion(ex);
        ...
        /// <returns></returns>
        public int Insert(PRESTACION_MUESTRA entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.AddToPRESTACION_MUESTRA(entity);
        ...
        /// <returns></returns>
        public bool Update(PRESTACION_MUESTRA entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.ApplyPropertyChanges("PRESTACION_MUESTRA", entity);
