...
namespace LQCE.Repositorio
{
	public partial class RepositorioCONVENIO
	{
        ...
        public IQueryable<CONVENIO> GetAll()
        {
            ...
            try
            {
                return from i in _contextBd.CONVENIO select i;
            }
            catch (Exception ex)
            {
                ISException.RegisterExcepcion(ex);
        ...
        /// <returns></returns>
        public int Insert(CONVENIO entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.AddToCONVENIO(entity);
        ...
        /// <returns></returns>
        public bool Update(CONVENIO entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.ApplyPropertyChanges("CONVENIO", entity);
