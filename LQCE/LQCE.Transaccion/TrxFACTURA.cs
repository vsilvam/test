...
namespace LQCE.Transaccion
{
	public partial class TrxFACTURA
	{
		...
		public FACTURA GetById(int id)
		{
			...
			{
				var dato = new RepositorioFACTURA(context);
      ...
      /// <returns></returns>
      public IList<FACTURA> Find(DTO_FACTURA dto)
      {
          Init();
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (dto != null)
              {
					...
					if (dto.NUMERO_FACTURA != null)
						q = q.Where(i => i.NUMERO_FACTURA  == dto.NUMERO_FACTURA);		
					if (dto.RUT_LABORATORIO != null)
						q = q.Where(i => i.RUT_LABORATORIO.Contains(dto.RUT_LABORATORIO));					
					if (dto.ACTIVO != null)
						q = q.Where(i => i.ACTIVO  == dto.ACTIVO);		
					if (dto.ID_CLIENTE != null)
						q = q.Where(i => i.CLIENTE.ID == dto.ID_CLIENTE);				
					if (dto.ID_FACTURACION != null)
						q = q.Where(i => i.FACTURACION.ID == dto.ID_FACTURACION);				
              }
      ...
      public int Save(FACTURA entity)
      {
          ...
          if (entity == null)
          {
              Error = "ArgumentNullException. La entidad a persistir 'FACTURA' no puede ser nula.";
          ...
          using (var context = new LQCEEntities())
          {
              ...
              oldEntity.NUMERO_FACTURA = entity.NUMERO_FACTURA;				
              oldEntity.RUT_LABORATORIO = entity.RUT_LABORATORIO;				
      ...
      public bool Delete(int id)
      {
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (entity == null)
              {
                  Error = String.Format("Registro '{0}' en 'FACTURA' no encontrado. {1}", id, dato.Error);
                  ISException.RegisterExcepcion(Error);
                  return false;
              }
