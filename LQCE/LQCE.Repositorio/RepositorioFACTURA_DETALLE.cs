	...
	public partial class RepositorioFACTURA_DETALLE
	{
		...
		public FACTURA_DETALLE GetByIdWithReferences(int id)
		{
			...
			try
			{
							...
							return _context.FACTURA_DETALLE.Include("PAGO_DETALLE").Include("FACTURA").Include("PRESTACION").FirstOrDefault(i => i.ID == id && i.ACTIVO );
		...
		public IQueryable<FACTURA_DETALLE> GetAllWithReferences()
		{
			...
			try
			{
								...
								var q = from i in _context.FACTURA_DETALLE.Include("PAGO_DETALLE").Include("FACTURA").Include("PRESTACION") where i.ACTIVO  select i;
							return q;
			}
			catch (Exception ex)
            {
