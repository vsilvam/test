...
namespace LQCE.Repositorio
{
	public partial class RepositorioPRESTACION_EXAMEN
	{
        ...
        public PRESTACION_EXAMEN GetById(int id)
        {
            ...
            try
            {
                return _contextBd.PRESTACION_EXAMEN
					.Include("EXAMEN")				
					.Include("PRESTACION")				
        ...
        public IQueryable<PRESTACION_EXAMEN> GetAll()
        {
            ...
            try
            {
                return from i in _contextBd.PRESTACION_EXAMEN select i;
            }
            catch (Exception ex)
            {
                ISException.RegisterExcepcion(ex);
        ...
        /// <returns></returns>
        public int Insert(PRESTACION_EXAMEN entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.AddToPRESTACION_EXAMEN(entity);
        ...
        /// <returns></returns>
        public bool Update(PRESTACION_EXAMEN entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.ApplyPropertyChanges("PRESTACION_EXAMEN", entity);
