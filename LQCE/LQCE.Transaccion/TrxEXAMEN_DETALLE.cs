...
namespace LQCE.Transaccion
{
	public partial class TrxEXAMEN_DETALLE
	{
		...
		public EXAMEN_DETALLE GetById(int id)
		{
			...
			{
				var dato = new RepositorioEXAMEN_DETALLE(context);
      ...
      /// </summary>
      /// <returns></returns>
      public IList<EXAMEN_DETALLE> GetAll()
      {
          Init();
      ...
      /// <returns></returns>
      public IList<EXAMEN_DETALLE> Find(DTO_EXAMEN_DETALLE dto)
      {
          Init();
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (dto != null)
              {
					...
					if (dto.ID_EXAMEN1 != null)
						q = q.Where(i => i.EXAMEN1.ID == dto.ID_EXAMEN1);				
              }
      ...
      /// <returns></returns>
      public int Save(EXAMEN_DETALLE entity)
      {
          Init();

          if (entity == null)
          {
              Error = "ArgumentNullException. La entidad a persistir 'EXAMEN_DETALLE' no puede ser nula.";
      ...
      public bool Delete(int id)
      {
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (entity == null)
              {
                  Error = String.Format("Registro '{0}' en 'EXAMEN_DETALLE' no encontrado. {1}", id, dato.Error);
                  ISException.RegisterExcepcion(Error);
                  return false;
              }
