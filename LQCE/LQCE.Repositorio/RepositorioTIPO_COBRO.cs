...
namespace LQCE.Repositorio
{
	public partial class RepositorioTIPO_COBRO
	{
        ...
        public IQueryable<TIPO_COBRO> GetAll()
        {
            ...
            try
            {
                return from i in _contextBd.TIPO_COBRO select i;
            }
            catch (Exception ex)
            {
                ISException.RegisterExcepcion(ex);
        ...
        /// <returns></returns>
        public int Insert(TIPO_COBRO entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.AddToTIPO_COBRO(entity);
        ...
        /// <returns></returns>
        public bool Update(TIPO_COBRO entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.ApplyPropertyChanges("TIPO_COBRO", entity);
