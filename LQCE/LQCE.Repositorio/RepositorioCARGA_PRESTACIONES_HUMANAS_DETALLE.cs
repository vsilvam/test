	...
	public partial class RepositorioCARGA_PRESTACIONES_HUMANAS_DETALLE
	{
		...
		public CARGA_PRESTACIONES_HUMANAS_DETALLE GetByIdWithReferences(int id)
		{
			...
			try
			{
							...
							return _context.CARGA_PRESTACIONES_HUMANAS_DETALLE.Include("CARGA_PRESTACIONES_ENCABEZADO").Include("CARGA_PRESTACIONES_HUMANAS_EXAMEN").Include("CARGA_PRESTACIONES_DETALLE_ESTADO").Include("CLIENTE").Include("GARANTIA1").Include("PREVISION1").FirstOrDefault(i => i.ID == id);
		...
		public IQueryable<CARGA_PRESTACIONES_HUMANAS_DETALLE> GetAllWithReferences()
		{
			...
			try
			{
								...
								var q = from i in _context.CARGA_PRESTACIONES_HUMANAS_DETALLE.Include("CARGA_PRESTACIONES_ENCABEZADO").Include("CARGA_PRESTACIONES_HUMANAS_EXAMEN").Include("CARGA_PRESTACIONES_DETALLE_ESTADO").Include("CLIENTE").Include("GARANTIA1").Include("PREVISION1") select i;
							return q;
			}
			catch (Exception ex)
            {
