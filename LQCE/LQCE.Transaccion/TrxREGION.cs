...
namespace LQCE.Transaccion
{
	public partial class TrxREGION
	{
		...
		public REGION GetById(int id)
		{
			...
			{
				var dato = new RepositorioREGION(context);
      ...
      /// <returns></returns>
      public IList<REGION> Find(DTO_REGION dto)
      {
          Init();
      ...
      public int Save(REGION entity)
      {
          ...
          if (entity == null)
          {
              Error = "ArgumentNullException. La entidad a persistir 'REGION' no puede ser nula.";
      ...
      public bool Delete(int id)
      {
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (entity == null)
              {
                  Error = String.Format("Registro '{0}' en 'REGION' no encontrado. {1}", id, dato.Error);
                  ISException.RegisterExcepcion(Error);
                  return false;
              }
