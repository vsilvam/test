...
/****** Object:  View [dbo].[VISTA_REPORTE_FACTURA]    Script Date: 10/14/2012 02:45:29 ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT     dbo.FACTURA.ID_FACTURACION, dbo.FACTURA.ID_TIPO_FACTURA, dbo.FACTURA.ID AS ID, dbo.FACTURACION.FECHA_FACTURACION, dbo.FACTURA.NOMBRE_CLIENTE, 
