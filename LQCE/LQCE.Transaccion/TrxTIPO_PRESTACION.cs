...
namespace LQCE.Transaccion
{
	public partial class TrxTIPO_PRESTACION
	{
		...
		public TIPO_PRESTACION GetById(int id)
		{
			...
			{
				var dato = new RepositorioTIPO_PRESTACION(context);
      ...
      /// </summary>
      /// <returns></returns>
      public IList<TIPO_PRESTACION> GetAll()
      {
          Init();
      ...
      /// <returns></returns>
      public IList<TIPO_PRESTACION> Find(DTO_TIPO_PRESTACION dto)
      {
          Init();
      ...
      /// <returns></returns>
      public int Save(TIPO_PRESTACION entity)
      {
          Init();

          if (entity == null)
          {
              Error = "ArgumentNullException. La entidad a persistir 'TIPO_PRESTACION' no puede ser nula.";
      ...
      public bool Delete(int id)
      {
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (entity == null)
              {
                  Error = String.Format("Registro '{0}' en 'TIPO_PRESTACION' no encontrado. {1}", id, dato.Error);
                  ISException.RegisterExcepcion(Error);
                  return false;
              }
