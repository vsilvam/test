...
namespace LQCE.Repositorio
{
	public partial class RepositorioCONVENIO_EXAMEN
	{
        ...
        public CONVENIO_EXAMEN GetById(int id)
        {
            ...
            try
            {
                return _contextBd.CONVENIO_EXAMEN
					.Include("CONVENIO_TARIFARIO")				
					.Include("EXAMEN")				
        ...
        public IQueryable<CONVENIO_EXAMEN> GetAll()
        {
            ...
            try
            {
                return from i in _contextBd.CONVENIO_EXAMEN select i;
            }
            catch (Exception ex)
            {
                ISException.RegisterExcepcion(ex);
        ...
        /// <returns></returns>
        public int Insert(CONVENIO_EXAMEN entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.AddToCONVENIO_EXAMEN(entity);
        ...
        /// <returns></returns>
        public bool Update(CONVENIO_EXAMEN entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.ApplyPropertyChanges("CONVENIO_EXAMEN", entity);
