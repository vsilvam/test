	...
	public partial class TrxCARGA_PRESTACIONES_HUMANAS_DETALLE
	{
		...
		public List<CARGA_PRESTACIONES_HUMANAS_DETALLE> GetByFilter(int? CARGA_PRESTACIONES_DETALLE_ESTADOId = null, int? CARGA_PRESTACIONES_ENCABEZADOId = null, int? CLIENTEId = null, int? GARANTIA1Id = null, int? PREVISION1Id = null, System.DateTime? FECHA_ACTUALIZACION = null, string FICHA = "", string NOMBRE = "", string RUT = "", string MEDICO = "", string EDAD = "", string TELEFONO = "", string PROCEDENCIA = "", string FECHA_RECEPCION = "", string MUESTRA = "", string FECHA_RESULTADOS = "", string PREVISION = "", string GARANTIA = "", string PAGADO = "", string PENDIENTE = "", string TOTAL = "", string RECEPCION = "", string MENSAJE_ERROR = "", int? VALOR_FICHA = null, DateTime? VALOR_FECHA_MUESTRA = null, DateTime? VALOR_FECHA_RECEPCION = null, DateTime? VALOR_FECHA_ENTREGA_RESULTADOS = null, int? VALOR_TOTAL = null)
        {
			...
			try
            {
                ...
                {
                    RepositorioCARGA_PRESTACIONES_HUMANAS_DETALLE repositorio = new RepositorioCARGA_PRESTACIONES_HUMANAS_DETALLE(context);
                    return repositorio.GetByFilter(CARGA_PRESTACIONES_DETALLE_ESTADOId, CARGA_PRESTACIONES_ENCABEZADOId, CLIENTEId, GARANTIA1Id, PREVISION1Id, FECHA_ACTUALIZACION, FICHA, NOMBRE, RUT, MEDICO, EDAD, TELEFONO, PROCEDENCIA, FECHA_RECEPCION, MUESTRA, FECHA_RESULTADOS, PREVISION, GARANTIA, PAGADO, PENDIENTE, TOTAL, RECEPCION, MENSAJE_ERROR, VALOR_FICHA, VALOR_FECHA_MUESTRA, VALOR_FECHA_RECEPCION, VALOR_FECHA_ENTREGA_RESULTADOS, VALOR_TOTAL).OrderBy(i => i.ID).ToList();
                }
            }
            catch (Exception ex)
            {
		...
		public List<CARGA_PRESTACIONES_HUMANAS_DETALLE> GetByFilterWithReferences(int? CARGA_PRESTACIONES_DETALLE_ESTADOId = null, int? CARGA_PRESTACIONES_ENCABEZADOId = null, int? CLIENTEId = null, int? GARANTIA1Id = null, int? PREVISION1Id = null, System.DateTime? FECHA_ACTUALIZACION = null, string FICHA = "", string NOMBRE = "", string RUT = "", string MEDICO = "", string EDAD = "", string TELEFONO = "", string PROCEDENCIA = "", string FECHA_RECEPCION = "", string MUESTRA = "", string FECHA_RESULTADOS = "", string PREVISION = "", string GARANTIA = "", string PAGADO = "", string PENDIENTE = "", string TOTAL = "", string RECEPCION = "", string MENSAJE_ERROR = "", int? VALOR_FICHA = null, DateTime? VALOR_FECHA_MUESTRA = null, DateTime? VALOR_FECHA_RECEPCION = null, DateTime? VALOR_FECHA_ENTREGA_RESULTADOS = null, int? VALOR_TOTAL = null)
        {
			Init();
            try
            {
                ...
                {
                    RepositorioCARGA_PRESTACIONES_HUMANAS_DETALLE repositorio = new RepositorioCARGA_PRESTACIONES_HUMANAS_DETALLE(context);
                    return repositorio.GetByFilterWithReferences(CARGA_PRESTACIONES_DETALLE_ESTADOId, CARGA_PRESTACIONES_ENCABEZADOId, CLIENTEId, GARANTIA1Id, PREVISION1Id, FECHA_ACTUALIZACION, FICHA, NOMBRE, RUT, MEDICO, EDAD, TELEFONO, PROCEDENCIA, FECHA_RECEPCION, MUESTRA, FECHA_RESULTADOS, PREVISION, GARANTIA, PAGADO, PENDIENTE, TOTAL, RECEPCION, MENSAJE_ERROR, VALOR_FICHA, VALOR_FECHA_MUESTRA, VALOR_FECHA_RECEPCION, VALOR_FECHA_ENTREGA_RESULTADOS, VALOR_TOTAL).OrderBy(i => i.ID).ToList();
                }
            }
            catch (Exception ex)
            {
