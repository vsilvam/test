...
namespace LQCE.Transaccion
{
	public partial class TrxESPECIE
	{
		...
		public ESPECIE GetById(int id)
		{
			...
			{
				var dato = new RepositorioESPECIE(context);
      ...
      /// <returns></returns>
      public IList<ESPECIE> Find(DTO_ESPECIE dto)
      {
          Init();
      ...
      /// <returns></returns>
      public int Save(ESPECIE entity)
      {
          Init();

          if (entity == null)
          {
              Error = "ArgumentNullException. La entidad a persistir 'ESPECIE' no puede ser nula.";
      ...
      public bool Delete(int id)
      {
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (entity == null)
              {
                  Error = String.Format("Registro '{0}' en 'ESPECIE' no encontrado. {1}", id, dato.Error);
                  ISException.RegisterExcepcion(Error);
                  return false;
              }
