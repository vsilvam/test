...
<%@ Register TagPrefix="WebPartPages" Namespace="Microsoft.SharePoint.WebPartPages"
    Assembly="Microsoft.SharePoint, Version=14.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AnularFactura.ascx.cs"
    Inherits="LQCE.SharePoint.ControlTemplates.Prestaciones.AnularFactura" %>
...
<article class="module width_full">
      ...
      <b>Procesos de Facturación</b>
        <asp:GridView ID="gridFacturacion" CssClass="tablesorter" runat="server"
...
<asp:Panel ID="panelAnular" runat="server" Visible="false">
    ...
    <asp:GridView ID="grdFacturas" runat="server" AutoGenerateColumns='False'
        Width='100%' DataKeyNames="ID_FACTURA" EnableModelValidation="True" 
        ...
        <EmptyDataTemplate>
            No hay facturas no numeradas.
        </EmptyDataTemplate>
    </asp:GridView>
    <uc1:Paginador ID="Paginador1" runat="server" OnPageChanged="Paginador1_PageChanged" />
    <asp:Button ID="btnAnular" runat="server" Text="Anular Facturas" 
