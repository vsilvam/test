...
namespace App.Infrastructure.Integration
{
    ...
    /// </summary>
    public class ISActiveDirectoryHelper
    {
        #region Private Variables

        private static readonly string ADPath = ISConfiguration.GetConfigurationParameter("Ldap", "_appLdap_Path");
        private static readonly string ADUser = ISConfiguration.GetConfigurationParameter("Ldap", "_appLdap_User");

        private static readonly string ADPassword = ISConfiguration.GetConfigurationParameter("Ldap",
                                                                                              "_appLdap_Password");
        ...
        /// <returns></returns>
        public static DataTable GetUsersByNameEmailCorporate(string LastName, string EmailAddress, string Corporate)
        {
            ...
            return GetUsersDataTable(SQLWhere.ToString());
        }
        ...
        private static DataTable CreateUserDataTable()
        {
            ...
            dt.Columns.Add("ChallengeQuestion");
            dt.Columns.Add("ChallengeResponse");
            dt.Columns.Add("MemberCompany");
            dt.Columns.Add("CompanyRelationShipExists");
            dt.Columns.Add("Status");
            dt.Columns.Add("AssignedSalesPerson");
            dt.Columns.Add("AcceptTAndC");
            dt.Columns.Add("Jobs");
            dt.Columns.Add("Email_Overnight");
            dt.Columns.Add("Email_DailyEmergingMarkets");
            dt.Columns.Add("Email_DailyCorporateAlerts");
            dt.Columns.Add("AssetMgtRange");
            dt.Columns.Add("ReferralCompany");
            dt.Columns.Add("CorporateAffiliation");
            dt.Columns.Add("DateCreated");
            dt.Columns.Add("DateLastModified");
            dt.Columns.Add("DateOfExpiry");
            dt.Columns.Add("AccountIsActive");
        ...
        /// <returns></returns>
        private static DataRow PopulateUserDataTable(SearchResult userSearchResult, DataTable userTable)
        {
            //set a new empty row
        ...
        public static SearchResultCollection ExecuteQuery(string query)
        {
            DirectoryEntry de = GetDirectoryObject();
            //create instance fo the direcory searcher
            var deSearch = new DirectorySearcher();
        ...
        /// <param name="UserName"></param>
        /// <returns></returns>
        public static DataTable GetUserDataTable(string UserName)
        {
            DirectoryEntry de = GetDirectoryObject();
            //create instance fo the direcory searcher
            var deSearch = new DirectorySearcher();
        ...
        /// <returns></returns>
        public static DataTable GetUsersDataTable(string Criteria)
        {
            DirectoryEntry de = GetDirectoryObject();
            //create instance fo the direcory searcher
            var deSearch = new DirectorySearcher();
            ...
            if (results.Count > 0)
            {
                ...
                {
                    //populate the dataset with the values from the results
                    dtUser.Rows.Add(PopulateUserDataTable(result, dtUser));
                }
            }
            de.Close();
            return dtUser;
        ...
        {
            var dtGroup = new DataTable("Groups");
            DirectoryEntry de = GetDirectoryObject();
            //create instance fo the direcory searcher
            var deSearch = new DirectorySearcher();
            //set the search filter
            ...
            deSearch.Filter = "(&(objectCategory=group)(name=*))";
        ...
        /// <param name="GroupName"></param>
        /// <returns></returns>
        public static DataTable GetUsersForGroup(string GroupName)
        {
            DirectoryEntry de = GetDirectoryObject();
