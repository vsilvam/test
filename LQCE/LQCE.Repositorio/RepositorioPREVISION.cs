...
namespace LQCE.Repositorio
{
	public partial class RepositorioPREVISION
	{
        ...
        public IQueryable<PREVISION> GetAll()
        {
            ...
            try
            {
                return from i in _contextBd.PREVISION select i;
            }
            catch (Exception ex)
            {
                ISException.RegisterExcepcion(ex);
        ...
        /// <returns></returns>
        public int Insert(PREVISION entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.AddToPREVISION(entity);
        ...
        /// <returns></returns>
        public bool Update(PREVISION entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.ApplyPropertyChanges("PREVISION", entity);
