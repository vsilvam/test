...
namespace LQCE.Repositorio
{
	public partial class RepositorioEXAMEN
	{
        ...
        public IQueryable<EXAMEN> GetAll()
        {
            ...
            try
            {
                return from i in _contextBd.EXAMEN select i;
            }
            catch (Exception ex)
            {
                ISException.RegisterExcepcion(ex);
        ...
        /// <returns></returns>
        public int Insert(EXAMEN entity)
        {
            Error = string.Empty;
            try
            {
                _contextBd.AddToEXAMEN(entity);
        ...
        public bool Update(EXAMEN entity)
        {
            ...
            try
            {
                _contextBd.ApplyPropertyChanges("EXAMEN", entity);
