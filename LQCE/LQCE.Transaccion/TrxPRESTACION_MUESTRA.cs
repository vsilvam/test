...
namespace LQCE.Transaccion
{
	public partial class TrxPRESTACION_MUESTRA
	{
		...
		public PRESTACION_MUESTRA GetById(int id)
		{
			...
			{
				var dato = new RepositorioPRESTACION_MUESTRA(context);
      ...
      /// </summary>
      /// <returns></returns>
      public IList<PRESTACION_MUESTRA> GetAll()
      {
          Init();
      ...
      /// <returns></returns>
      public IList<PRESTACION_MUESTRA> Find(DTO_PRESTACION_MUESTRA dto)
      {
          Init();
      ...
      /// <returns></returns>
      public int Save(PRESTACION_MUESTRA entity)
      {
          Init();

          if (entity == null)
          {
              Error = "ArgumentNullException. La entidad a persistir 'PRESTACION_MUESTRA' no puede ser nula.";
      ...
      public bool Delete(int id)
      {
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (entity == null)
              {
                  Error = String.Format("Registro '{0}' en 'PRESTACION_MUESTRA' no encontrado. {1}", id, dato.Error);
                  ISException.RegisterExcepcion(Error);
                  return false;
              }
