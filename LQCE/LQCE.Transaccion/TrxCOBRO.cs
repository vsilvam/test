...
namespace LQCE.Transaccion
{
	public partial class TrxCOBRO
	{
		...
		public COBRO GetById(int id)
		{
			...
			{
				var dato = new RepositorioCOBRO(context);
      ...
      /// <returns></returns>
      public IList<COBRO> Find(DTO_COBRO dto)
      {
          Init();
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (dto != null)
              {
					...
					if (dto.FECHA_COBRO != null)
						q = q.Where(i => i.FECHA_COBRO  == dto.FECHA_COBRO);		
					if (dto.ACTIVO != null)
						q = q.Where(i => i.ACTIVO  == dto.ACTIVO);		
					if (dto.ID_TIPO_COBRO != null)
						q = q.Where(i => i.TIPO_COBRO.ID == dto.ID_TIPO_COBRO);				
              }
      ...
      /// <returns></returns>
      public int Save(COBRO entity)
      {
          Init();

          if (entity == null)
          {
              Error = "ArgumentNullException. La entidad a persistir 'COBRO' no puede ser nula.";
          ...
          using (var context = new LQCEEntities())
          {
              ...
              oldEntity.FECHA_COBRO = entity.FECHA_COBRO;				
      ...
      public bool Delete(int id)
      {
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (entity == null)
              {
                  Error = String.Format("Registro '{0}' en 'COBRO' no encontrado. {1}", id, dato.Error);
                  ISException.RegisterExcepcion(Error);
                  return false;
              }
