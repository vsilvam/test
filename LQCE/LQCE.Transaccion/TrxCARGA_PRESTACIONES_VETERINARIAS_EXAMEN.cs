...
namespace LQCE.Transaccion
{
	public partial class TrxCARGA_PRESTACIONES_VETERINARIAS_EXAMEN
	{
		...
		public List<CARGA_PRESTACIONES_VETERINARIAS_EXAMEN> GetByFilter(int? EXAMENId = null, int? CARGA_PRESTACIONES_VETERINARIAS_DETALLEId = null, System.DateTime? FECHA_ACTUALIZACION = null, string NOMBRE_EXAMEN = "", string VALOR_EXAMEN = "", int? VALOR_VALOR_EXAMEN = null)
        {
			Init();
			try
            {
                ...
                {
                    RepositorioCARGA_PRESTACIONES_VETERINARIAS_EXAMEN repositorio = new RepositorioCARGA_PRESTACIONES_VETERINARIAS_EXAMEN(context);
                    return repositorio.GetByFilter(EXAMENId, CARGA_PRESTACIONES_VETERINARIAS_DETALLEId, FECHA_ACTUALIZACION, NOMBRE_EXAMEN, VALOR_EXAMEN, VALOR_VALOR_EXAMEN).OrderBy(i => i.ID).ToList();
                }
            }
            catch (Exception ex)
            {
		...
		public List<CARGA_PRESTACIONES_VETERINARIAS_EXAMEN> GetByFilterWithReferences(int? EXAMENId = null, int? CARGA_PRESTACIONES_VETERINARIAS_DETALLEId = null, System.DateTime? FECHA_ACTUALIZACION = null, string NOMBRE_EXAMEN = "", string VALOR_EXAMEN = "", int? VALOR_VALOR_EXAMEN = null)
        {
			Init();
            try
            {
                ...
                {
                    RepositorioCARGA_PRESTACIONES_VETERINARIAS_EXAMEN repositorio = new RepositorioCARGA_PRESTACIONES_VETERINARIAS_EXAMEN(context);
                    return repositorio.GetByFilterWithReferences(EXAMENId, CARGA_PRESTACIONES_VETERINARIAS_DETALLEId, FECHA_ACTUALIZACION, NOMBRE_EXAMEN, VALOR_EXAMEN, VALOR_VALOR_EXAMEN).OrderBy(i => i.ID).ToList();
                }
            }
            catch (Exception ex)
            {
