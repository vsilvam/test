...
namespace LQCE.Transaccion
{
	public partial class TrxEXAMEN
	{
		...
		public EXAMEN GetById(int id)
		{
			...
			{
				var dato = new RepositorioEXAMEN(context);
      ...
      /// <returns></returns>
      public IList<EXAMEN> Find(DTO_EXAMEN dto)
      {
          Init();
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (dto != null)
              {
					...
					if (dto.CODIGO != null)
						q = q.Where(i => i.CODIGO.Contains(dto.CODIGO));					
					if (dto.NOMBRE != null)
      ...
      /// <returns></returns>
      public int Save(EXAMEN entity)
      {
          Init();

          if (entity == null)
          {
              Error = "ArgumentNullException. La entidad a persistir 'EXAMEN' no puede ser nula.";
          ...
          using (var context = new LQCEEntities())
          {
              ...
              oldEntity.CODIGO = entity.CODIGO;				
      ...
      public bool Delete(int id)
      {
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (entity == null)
              {
                  Error = String.Format("Registro '{0}' en 'EXAMEN' no encontrado. {1}", id, dato.Error);
                  ISException.RegisterExcepcion(Error);
                  return false;
              }
