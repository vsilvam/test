...
namespace LQCE.Repositorio
{
	public partial class RepositorioCARGA_PRESTACIONES_ESTADO
	{
		...
		public CARGA_PRESTACIONES_ESTADO GetById(int id)
		{
			...
			try
			{
				return _context.CARGA_PRESTACIONES_ESTADO.FirstOrDefault(i => i.ID == id && i.ACTIVO );
			}
			catch (Exception ex)
            {
		...
		public CARGA_PRESTACIONES_ESTADO GetByIdWithReferences(int id)
		{
			...
			try
			{
				return _context.CARGA_PRESTACIONES_ESTADO.Include("CARGA_PRESTACIONES_ENCABEZADO").FirstOrDefault(i => i.ID == id && i.ACTIVO );
			}
			catch (Exception ex)
            {
                ISException.RegisterExcepcion(ex);
		...
		public IQueryable<CARGA_PRESTACIONES_ESTADO> GetAll()
		{
			...
			try
			{
				var q = from i in _context.CARGA_PRESTACIONES_ESTADO  where i.ACTIVO select i;
				return q;
			}
			catch (Exception ex)
            {
		...
		public IQueryable<CARGA_PRESTACIONES_ESTADO> GetAllWithReferences()
		{
			...
			try
			{
				var q = from i in _context.CARGA_PRESTACIONES_ESTADO.Include("CARGA_PRESTACIONES_ENCABEZADO") where i.ACTIVO  select i;
				return q;
			}
			catch (Exception ex)
            {
