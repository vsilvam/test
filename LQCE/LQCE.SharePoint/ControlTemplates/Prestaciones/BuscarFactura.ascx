...
<asp:Panel ID='pnBusquedaFactura' runat='server'>
    ...
    <table width="100%">
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtRutCliente" runat="server" onblur="javascript:EsRut(this);" ></asp:TextBox>
                12345678-9
...
<asp:Panel ID='pnFacturas' runat='server' Visible='false'>
    <asp:GridView ID="grdFacturas" runat="server" GridLines="Both" AutoGenerateColumns='false'
        ...
        <Columns>
            <asp:BoundField HeaderText="Número Factura" DataField="NUMERO_FACTURA" ItemStyle-HorizontalAlign="Center"/>
            <asp:BoundField HeaderText="RUT" DataField="RUT_CLIENTE" ItemStyle-HorizontalAlign="Center"/>
            <asp:BoundField HeaderText="Cliente" DataField="NOMBRE_CLIENTE" ItemStyle-HorizontalAlign="Center"/>
            <asp:BoundField HeaderText="Fecha de Emisión" DataField="FECHA_EMISION" ItemStyle-HorizontalAlign="Center"/>
            <asp:BoundField HeaderText="Total" DataField="VALOR_TOTAL" ItemStyle-HorizontalAlign="Center"/>
            <asp:BoundField HeaderText="Pagado" DataField="VALOR_PAGADO" ItemStyle-HorizontalAlign="Center"/>
            <asp:BoundField HeaderText="Total Pagos" DataField="PAGOS_REGISTRADOS" ItemStyle-HorizontalAlign="Center"/>
            <asp:BoundField HeaderText="Saldo Deudor" DataField="SALDO_DEUDOR" ItemStyle-HorizontalAlign="Center"/>
