...
namespace LQCE.Repositorio
{
	public partial class RepositorioCARGA_PRESTACIONES_DETALLE_ESTADO
	{
		...
		public CARGA_PRESTACIONES_DETALLE_ESTADO GetById(int id)
		{
			...
			try
			{
							return _context.CARGA_PRESTACIONES_DETALLE_ESTADO.FirstOrDefault(i => i.ID == id);
						}
			catch (Exception ex)
            {
		...
		public CARGA_PRESTACIONES_DETALLE_ESTADO GetByIdWithReferences(int id)
		{
			...
			try
			{
							...
							return _context.CARGA_PRESTACIONES_DETALLE_ESTADO.Include("CARGA_PRESTACIONES_HUMANAS_DETALLE").Include("CARGA_PRESTACIONES_VETERINARIAS_DETALLE").FirstOrDefault(i => i.ID == id);
		...
		public IQueryable<CARGA_PRESTACIONES_DETALLE_ESTADO> GetAll()
		{
			...
			try
			{
							...
							var q = from i in _context.CARGA_PRESTACIONES_DETALLE_ESTADO select i;
							return q;
			}
			catch (Exception ex)
            {
		...
		public IQueryable<CARGA_PRESTACIONES_DETALLE_ESTADO> GetAllWithReferences()
		{
			...
			try
			{
								...
								var q = from i in _context.CARGA_PRESTACIONES_DETALLE_ESTADO.Include("CARGA_PRESTACIONES_HUMANAS_DETALLE").Include("CARGA_PRESTACIONES_VETERINARIAS_DETALLE") select i;
							return q;
			}
			catch (Exception ex)
            {
