	...
	public partial class RepositorioRAZA
	{
		...
		public RAZA GetByIdWithReferences(int id)
		{
			...
			try
			{
							...
							return _context.RAZA.Include("ESPECIE").Include("PRESTACION_VETERINARIA").Include("CARGA_PRESTACIONES_VETERINARIAS_DETALLE").FirstOrDefault(i => i.ID == id);
		...
		public IQueryable<RAZA> GetAllWithReferences()
		{
			...
			try
			{
								...
								var q = from i in _context.RAZA.Include("ESPECIE").Include("PRESTACION_VETERINARIA").Include("CARGA_PRESTACIONES_VETERINARIAS_DETALLE") select i;
							return q;
			}
			catch (Exception ex)
            {
