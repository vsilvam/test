...
namespace LQCE.Transaccion
{
	public partial class TrxEXAMEN_DETALLE
	{
		...
		public List<EXAMEN_DETALLE> GetByFilter(int? EXAMENId = null, int? EXAMEN1Id = null, bool? ACTIVO = null)
        {
			Init();
			try
            {
                ...
                {
                    RepositorioEXAMEN_DETALLE repositorio = new RepositorioEXAMEN_DETALLE(context);
                    return repositorio.GetByFilter(EXAMENId, EXAMEN1Id, ACTIVO).OrderBy(i => i.ID).ToList();
                }
            }
            catch (Exception ex)
            {
		...
		public List<EXAMEN_DETALLE> GetByFilterWithReferences(int? EXAMENId = null, int? EXAMEN1Id = null, bool? ACTIVO = null)
        {
			Init();
            try
            {
                ...
                {
                    RepositorioEXAMEN_DETALLE repositorio = new RepositorioEXAMEN_DETALLE(context);
                    return repositorio.GetByFilterWithReferences(EXAMENId, EXAMEN1Id, ACTIVO).OrderBy(i => i.ID).ToList();
                }
            }
            catch (Exception ex)
            {
		...
		Init();
            try
            {
				 using (LQCEEntities context = new LQCEEntities())
				{
					...
					RepositorioEXAMEN1 _repositorioEXAMEN1 = new RepositorioEXAMEN1(context);
					EXAMEN1 _objEXAMEN1 = _repositorioEXAMEN1.GetById(EXAMEN1Id);
