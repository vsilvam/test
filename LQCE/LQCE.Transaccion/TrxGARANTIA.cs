...
namespace LQCE.Transaccion
{
	public partial class TrxGARANTIA
	{
		...
		public GARANTIA GetById(int id)
		{
			...
			{
				var dato = new RepositorioGARANTIA(context);
      ...
      /// <returns></returns>
      public IList<GARANTIA> Find(DTO_GARANTIA dto)
      {
          Init();
      ...
      /// <returns></returns>
      public int Save(GARANTIA entity)
      {
          Init();

          if (entity == null)
          {
              Error = "ArgumentNullException. La entidad a persistir 'GARANTIA' no puede ser nula.";
      ...
      public bool Delete(int id)
      {
          ...
          using (var context = new LQCEEntities())
          {
              ...
              if (entity == null)
              {
                  Error = String.Format("Registro '{0}' en 'GARANTIA' no encontrado. {1}", id, dato.Error);
                  ISException.RegisterExcepcion(Error);
                  return false;
              }
