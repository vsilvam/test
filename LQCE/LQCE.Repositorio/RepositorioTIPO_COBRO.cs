...
namespace LQCE.Repositorio
{
	public partial class RepositorioTIPO_COBRO
	{
		...
		public IQueryable<TIPO_COBRO> GetByFilter(string NOMBRE = "", bool? ACTIVO = null)
		{
			Error = string.Empty;
			try
			{
		...
		public IQueryable<TIPO_COBRO> GetByFilterWithReferences(string NOMBRE = "", bool? ACTIVO = null)
		{
			Error = string.Empty;
			try
			{
