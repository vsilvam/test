...
namespace LQCE.Transaccion
{
	public partial class TrxCARGA_PRESTACIONES_HUMANAS_EXAMEN
	{
		...
		public List<CARGA_PRESTACIONES_HUMANAS_EXAMEN> GetByFilter(int? CARGA_PRESTACIONES_HUMANAS_DETALLEId = null, int? EXAMENId = null, System.DateTime? FECHA_ACTUALIZACION = null, string NOMBRE_EXAMEN = "", string VALOR_EXAMEN = "")
        {
			Init();
			try
            {
                ...
                {
                    RepositorioCARGA_PRESTACIONES_HUMANAS_EXAMEN repositorio = new RepositorioCARGA_PRESTACIONES_HUMANAS_EXAMEN(context);
                    return repositorio.GetByFilter(CARGA_PRESTACIONES_HUMANAS_DETALLEId, EXAMENId, FECHA_ACTUALIZACION, NOMBRE_EXAMEN, VALOR_EXAMEN).OrderBy(i => i.ID).ToList();
                }
            }
            catch (Exception ex)
            {
		...
		public List<CARGA_PRESTACIONES_HUMANAS_EXAMEN> GetByFilterWithReferences(int? CARGA_PRESTACIONES_HUMANAS_DETALLEId = null, int? EXAMENId = null, System.DateTime? FECHA_ACTUALIZACION = null, string NOMBRE_EXAMEN = "", string VALOR_EXAMEN = "")
        {
			Init();
            try
            {
                ...
                {
                    RepositorioCARGA_PRESTACIONES_HUMANAS_EXAMEN repositorio = new RepositorioCARGA_PRESTACIONES_HUMANAS_EXAMEN(context);
                    return repositorio.GetByFilterWithReferences(CARGA_PRESTACIONES_HUMANAS_DETALLEId, EXAMENId, FECHA_ACTUALIZACION, NOMBRE_EXAMEN, VALOR_EXAMEN).OrderBy(i => i.ID).ToList();
                }
            }
            catch (Exception ex)
            {
        ...
        public int Add(int CARGA_PRESTACIONES_HUMANAS_DETALLEId, int EXAMENId, System.DateTime FECHA_ACTUALIZACION, string NOMBRE_EXAMEN = "", string VALOR_EXAMEN = "")
        {
		Init();
            try
            {
		...
		public void Update(int Id, int CARGA_PRESTACIONES_HUMANAS_DETALLEId, int EXAMENId, System.DateTime FECHA_ACTUALIZACION, string NOMBRE_EXAMEN = "", string VALOR_EXAMEN = "")
		{
		Init();
			try
			{
